...
public class Student {
    ...
    public void addGrade(int courseCredits, double grade) {
        ...
        double newTotalQuantity = courseCredits*grade;
        double oldTotalQuantity = this.numberOfCredits*this.gpa;
        this.numberOfCredits = this.numberOfCredits+courseCredits;
        double totalQuantity = newTotalQuantity+oldTotalQuantity;
        this.gpa = totalQuantity/this.numberOfCredits;
    }
